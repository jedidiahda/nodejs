    ...
    [
      ...
      function(LoopBackResource, LoopBackAuth, $injector, $q) {
        ...
        R["removeById"] = R["deleteById"];
            ...
            /**
             * @ngdoc method
             * @name lbServices.Note#updateAttributes
             * @methodOf lbServices.Note
             *
             * @description
             *
      ...
      function(LoopBackResource, LoopBackAuth, $injector, $q) {
        ...
        urlBase + "/items/:id",
          { 'id': '@id' },
          {
            ...
            // INTERNAL. Use Item.orderdetails() instead.
            "prototype$__get__orderdetails": {
              url: urlBase + "/items/:id/orderdetails",
              method: "GET",
            },
            ...
            // INTERNAL. Use Orderdetails.items.findById() instead.
            "::findById::Orderdetails::items": {
              params: {
                'fk': '@fk',
              },
              url: urlBase + "/orderdetails/:id/items/:fk",
              method: "GET",
            },

            // INTERNAL. Use Orderdetails.items.destroyById() instead.
            "::destroyById::Orderdetails::items": {
              params: {
                'fk': '@fk',
              },
              url: urlBase + "/orderdetails/:id/items/:fk",
            ...
            // INTERNAL. Use Orderdetails.items.updateById() instead.
            "::updateById::Orderdetails::items": {
              params: {
                'fk': '@fk',
              },
              url: urlBase + "/orderdetails/:id/items/:fk",
            ...
            // INTERNAL. Use Orderdetails.items() instead.
            "::get::Orderdetails::items": {
              isArray: true,
              url: urlBase + "/orderdetails/:id/items",
              method: "GET",
            },

            // INTERNAL. Use Orderdetails.items.create() instead.
            "::create::Orderdetails::items": {
              url: urlBase + "/orderdetails/:id/items",
              method: "POST",
            },

            // INTERNAL. Use Orderdetails.items.createMany() instead.
            "::createMany::Orderdetails::items": {
              isArray: true,
              url: urlBase + "/orderdetails/:id/items",
              method: "POST",
            },

            // INTERNAL. Use Orderdetails.items.destroyAll() instead.
            "::delete::Orderdetails::items": {
              url: urlBase + "/orderdetails/:id/items",
              method: "DELETE",
            },

            // INTERNAL. Use Orderdetails.items.count() instead.
            "::count::Orderdetails::items": {
              url: urlBase + "/orderdetails/:id/items/count",
              method: "GET",
            },
          }
        );
        ...
        */
        R.modelName = "Item";
            ...
            /**
             * @ngdoc method
             * @name lbServices.Item#orderdetails
             * @methodOf lbServices.Item
             *
             * @description
             *
             * Fetches belongsTo relation orderdetails.
             *
             * @param {Object=} parameters Request parameters.
             *
             *  - `id` – `{*}` - item id
             ...
             * <em>
             * (The remote method definition does not provide any description.
             * This usually means the response is a `Orderdetails` object.)
             * </em>
             */
        R.orderdetails = function() {
          var TargetResource = $injector.get("Orderdetails");
          var action = TargetResource["::get::Item::orderdetails"];
...
/**
 * @ngdoc object
 * @name lbServices.Orderdetails
 * @header lbServices.Orderdetails
 * @object
 *
 * @description
 *
 * A $resource object for interacting with the `Orderdetails` model.
 *
 * ## Example
 *
 * See
  ...
  module.factory(
      ...
      function(LoopBackResource, LoopBackAuth, $injector, $q) {
        ...
        urlBase + "/orderdetails/:id",
          { 'id': '@id' },
          {
            ...
            /**
             * @ngdoc method
             * @name lbServices.Orderdetails#create
             * @methodOf lbServices.Orderdetails
             *
             * @description
             *
             * Create a new instance of the model and persist it into the data source.
             ...
             */
            "create": {
              url: urlBase + "/orderdetails",
              method: "POST",
            },

            /**
             * @ngdoc method
             * @name lbServices.Orderdetails#createMany
             * @methodOf lbServices.Orderdetails
             *
             * @description
             *
            ...
            /**
             * @ngdoc method
             * @name lbServices.Orderdetails#patchOrCreate
             * @methodOf lbServices.Orderdetails
             *
             * @description
             *
            ...
            /**
             * @ngdoc method
             * @name lbServices.Orderdetails#replaceOrCreate
             * @methodOf lbServices.Orderdetails
             *
             * @description
             *
             ...
             */
            "replaceOrCreate": {
              url: urlBase + "/orderdetails/replaceOrCreate",
              method: "POST",
            },

            /**
             * @ngdoc method
             * @name lbServices.Orderdetails#upsertWithWhere
             * @methodOf lbServices.Orderdetails
             *
             * @description
             *
             ...
             */
            "upsertWithWhere": {
              url: urlBase + "/orderdetails/upsertWithWhere",
              method: "POST",
            },

            /**
             * @ngdoc method
             * @name lbServices.Orderdetails#exists
             * @methodOf lbServices.Orderdetails
             *
             * @description
             *
             ...
             */
            "exists": {
              url: urlBase + "/orderdetails/:id/exists",
              method: "GET",
            },

            /**
             * @ngdoc method
             * @name lbServices.Orderdetails#findById
             * @methodOf lbServices.Orderdetails
             *
             * @description
             *
             ...
             */
            "findById": {
              url: urlBase + "/orderdetails/:id",
              method: "GET",
            },

            /**
             * @ngdoc method
             * @name lbServices.Orderdetails#replaceById
             * @methodOf lbServices.Orderdetails
             *
             * @description
             *
             ...
             */
            "replaceById": {
              url: urlBase + "/orderdetails/:id/replace",
              method: "POST",
            },

            /**
             * @ngdoc method
             * @name lbServices.Orderdetails#find
             * @methodOf lbServices.Orderdetails
             *
             * @description
             *
            ...
            /**
             * @ngdoc method
             * @name lbServices.Orderdetails#findOne
             * @methodOf lbServices.Orderdetails
             *
             * @description
             *
             ...
             */
            "findOne": {
              url: urlBase + "/orderdetails/findOne",
              method: "GET",
            },

            /**
             * @ngdoc method
             * @name lbServices.Orderdetails#updateAll
             * @methodOf lbServices.Orderdetails
             *
             * @description
             *
             ...
             */
            "updateAll": {
              url: urlBase + "/orderdetails/update",
              method: "POST",
            },

            /**
             * @ngdoc method
             * @name lbServices.Orderdetails#deleteById
             * @methodOf lbServices.Orderdetails
             *
             * @description
             *
            ...
            /**
             * @ngdoc method
             * @name lbServices.Orderdetails#count
             * @methodOf lbServices.Orderdetails
             *
             * @description
             *
             ...
             */
            "count": {
              url: urlBase + "/orderdetails/count",
              method: "GET",
            },

            /**
             * @ngdoc method
             * @name lbServices.Orderdetails#prototype$patchAttributes
             * @methodOf lbServices.Orderdetails
             *
             * @description
             *
            ...
            /**
             * @ngdoc method
             * @name lbServices.Orderdetails#createChangeStream
             * @methodOf lbServices.Orderdetails
             *
             * @description
             *
             ...
             */
            "createChangeStream": {
              url: urlBase + "/orderdetails/change-stream",
              method: "POST",
            },

            // INTERNAL. Use Item.orderdetails() instead.
            "::get::Item::orderdetails": {
              url: urlBase + "/items/:id/orderdetails",
              method: "GET",
            },
          }
            ...
            /**
             * @ngdoc method
             * @name lbServices.Orderdetails#upsert
             * @methodOf lbServices.Orderdetails
             *
             * @description
             *
        ...
        R["upsert"] = R["patchOrCreate"];
            ...
            /**
             * @ngdoc method
             * @name lbServices.Orderdetails#updateOrCreate
             * @methodOf lbServices.Orderdetails
             *
             * @description
             *
        ...
        R["updateOrCreate"] = R["patchOrCreate"];
            ...
            /**
             * @ngdoc method
             * @name lbServices.Orderdetails#patchOrCreateWithWhere
             * @methodOf lbServices.Orderdetails
             *
             * @description
             *
        ...
        R["patchOrCreateWithWhere"] = R["upsertWithWhere"];
            ...
            /**
             * @ngdoc method
             * @name lbServices.Orderdetails#update
             * @methodOf lbServices.Orderdetails
             *
             * @description
             *
        ...
        R["update"] = R["updateAll"];
            ...
            /**
             * @ngdoc method
             * @name lbServices.Orderdetails#destroyById
             * @methodOf lbServices.Orderdetails
             *
             * @description
             *
        ...
        R["destroyById"] = R["deleteById"];
            ...
            /**
             * @ngdoc method
             * @name lbServices.Orderdetails#removeById
             * @methodOf lbServices.Orderdetails
             *
             * @description
             *
        ...
        R["removeById"] = R["deleteById"];
            ...
            /**
             * @ngdoc method
             * @name lbServices.Orderdetails#updateAttributes
             * @methodOf lbServices.Orderdetails
             *
             * @description
             *
        ...
        /**
        * @ngdoc property
        * @name lbServices.Orderdetails#modelName
        * @propertyOf lbServices.Orderdetails
        * @description
        * The name of the model represented by this $resource,
        * i.e. `Orderdetails`.
        */
        R.modelName = "Orderdetails";

    /**
     * @ngdoc object
     * @name lbServices.Orderdetails.items
     * @header lbServices.Orderdetails.items
     * @object
     * @description
     *
     * The object `Orderdetails.items` groups methods
     * manipulating `Item` instances related to `Orderdetails`.
     *
     * Call {@link lbServices.Orderdetails#items Orderdetails.items()}
     ...
     */
        ...
        R.items = function() {
          ...
          var action = TargetResource["::get::Orderdetails::items"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Orderdetails.items#count
             * @methodOf lbServices.Orderdetails.items
             *
             * @description
             *
             * Counts items of orderdetails.
             *
             * @param {Object=} parameters Request parameters.
             *
             *  - `id` – `{*}` - orderdetails id
        ...
        R.items.count = function() {
          var TargetResource = $injector.get("Item");
          var action = TargetResource["::count::Orderdetails::items"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Orderdetails.items#create
             * @methodOf lbServices.Orderdetails.items
             *
             * @description
             *
        ...
        R.items.create = function() {
          var TargetResource = $injector.get("Item");
          var action = TargetResource["::create::Orderdetails::items"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Orderdetails.items#createMany
             * @methodOf lbServices.Orderdetails.items
             *
             * @description
             *
        ...
        R.items.createMany = function() {
          var TargetResource = $injector.get("Item");
          var action = TargetResource["::createMany::Orderdetails::items"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Orderdetails.items#destroyAll
             * @methodOf lbServices.Orderdetails.items
             *
             * @description
             *
        ...
        R.items.destroyAll = function() {
          var TargetResource = $injector.get("Item");
          var action = TargetResource["::delete::Orderdetails::items"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Orderdetails.items#destroyById
             * @methodOf lbServices.Orderdetails.items
             *
             * @description
             *
        ...
        R.items.destroyById = function() {
          var TargetResource = $injector.get("Item");
          var action = TargetResource["::destroyById::Orderdetails::items"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Orderdetails.items#findById
             * @methodOf lbServices.Orderdetails.items
             *
             * @description
             *
        ...
        R.items.findById = function() {
          var TargetResource = $injector.get("Item");
          var action = TargetResource["::findById::Orderdetails::items"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Orderdetails.items#updateById
             * @methodOf lbServices.Orderdetails.items
             *
             * @description
             *
        ...
        R.items.updateById = function() {
          var TargetResource = $injector.get("Item");
          var action = TargetResource["::updateById::Orderdetails::items"];
          return action.apply(R, arguments);
        };
